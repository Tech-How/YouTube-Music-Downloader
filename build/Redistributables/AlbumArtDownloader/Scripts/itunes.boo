	...
	def Search(artist as string, album as string, results as IScriptResults):
		...
		for result as Dictionary[of string, object] in searchResults["results"]:
			...
			if CheckResponse(imageUrlBase + "jpg"):
				...
				extension = "jpg"
			elif CheckResponse(imageUrlBase + "600x600-100.jpg"):	//we can often get full size image!
				fullSizeImageUrl = imageUrlBase + "600x600-100.jpg"
				extension = "jpg"
			elif CheckResponse(imageUrlBase + "600x600-75.jpg"):
				...
				extension = "tiff"
			elif CheckResponse(imageUrlBase + "600x600-75.jpg"): // Couldn't find full size .jpg or .tif, fall back on 1200x1200
				fullSizeImageUrl = imageUrlBase + "600x600-75.jpg"
				extension = "jpg"
			else:
