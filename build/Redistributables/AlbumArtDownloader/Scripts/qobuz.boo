...
class Qobuz(AlbumArtDownloader.Scripts.IScript):
	Locale = "fr-fr" // Default for qobuz.com is fr-fr, but other possibilities are: at-de, be-fr, be-nl, ch-de, ch-fr, de-de, es-es, gb-en, ie-en, it-it, lu-de, lu-fr, nl-nl
					 // Different locales have different catalogues of albums available.

	Name as string:
		get: return "Qobuz (" + Locale + ")"
	Version as string:
		get: return "0.4"
	Author as string:
	...
	def Search(artist as string, album as string, results as IScriptResults):
		...
		searchResultsHtml as string = GetPage("http://www.qobuz.com/" + Locale + "/search?i=boutique&q=" + EncodeUrl(artist + " " + album))
